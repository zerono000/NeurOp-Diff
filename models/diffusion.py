...
class UNet(nn.Module):
    def __init__(self, config):
        ...
        inner_channel = config.model.inner_channel
        ...
        with_noise_level_emb = config.model.with_noise_level_emb
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.states = torch.load(config.srno_weight, weights_only=True)

        self.srno = SRNO(config)
        self.srno.load_state_dict(self.states['model'])
        self.srno.eval()
